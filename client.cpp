...
private:
	...
	struct fileDownloadMeta
	{
		...
		fileDownloadMeta(string &status_, string &groupName_, string &fileName_) : status(status_), groupName(groupName_), fileName(fileName_)
		{
		}
...
{
	// unique_lock<mutex> ulk_//cerr(//cerr_mtx);
